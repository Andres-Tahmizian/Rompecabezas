...
var instrucciones = ['Usa la flechas del teclado para mover los bloques', 'El juego termina cuando armes el rompecabezas','Buena suerte'];
...
*/
function intercambiarPosicionesGrilla(fila1, columna1, fila2, columna2) {
 
    let temp = grilla[fila1][columna1];
...
function posicionValida(fila, columna) {
  ...
  // for(i=0; i<grilla.length; i++){
  //   for(j=0; j<grilla.length; j++){
  //   let validar = grilla[i][j];
  //    if(validar[fila][columna] < 3){
  //      alert('entro');
  //    }else{
  //      alert('no entro');
  //    }
